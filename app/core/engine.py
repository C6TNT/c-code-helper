...
from app.core.explainer import build_code_explanation, build_reading_steps, build_syntax_summary
...
def analyze_code(code_text: str) -> dict:
    ...
    return format_result(features, scene, syntax_summary, steps, explanation)
